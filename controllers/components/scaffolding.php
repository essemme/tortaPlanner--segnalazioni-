 ...
 */
	...
	function add($controller, $params = array()) {
	...
	function edit($controller, $id = null, $params = array()) {
		$params = array_merge(array(
			'redirect' => array('action' => 'index'),
		), $params);
	...
	function delete($controller, $id = null, $params = array()) {
		$params = array_merge(array(
			'redirect' => array('action' => 'index'),
		), $params);
		if (!$id) {
	...
	function view($controller, $id = null, $params = array()) {
		$params = array_merge(array(
			'redirect' => array('action' => 'index'),
		), $params);
	...
	function populateRelated($controller, $params) {
